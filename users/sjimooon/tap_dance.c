...
void td_quad_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (data->context->state ) {
        case TD_SINGLE_TAP:
            register_code16_sjimooon(data->kc1);
            break;
        case TD_SINGLE_HOLD:
            register_code16_sjimooon(data->kc2);
            break;
        case TD_DOUBLE_TAP:
            register_code16_sjimooon(data->kc3);
            break;
        case TD_DOUBLE_HOLD:
            register_code16_sjimooon(data->kc4);
            break;
...
void td_quad_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (data->context->state) {
        case TD_SINGLE_TAP:
            unregister_code16_sjimooon(data->kc1);
            break;
        case TD_SINGLE_HOLD:
            unregister_code16_sjimooon(data->kc2);
            break;
        case TD_DOUBLE_TAP:
            unregister_code16_sjimooon(data->kc3);
            break;
        case TD_DOUBLE_HOLD:
            unregister_code16_sjimooon(data->kc4);
            break;
        case TD_DOUBLE_SINGLE_TAP:
            unregister_code16_sjimooon(data->kc1);
            break;
...
void td_quad_tap_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (data->context->state ) {
        case TD_SINGLE_TAP:
            ...
            break;
        case TD_SINGLE_HOLD:
            tap_code16_sjimooon(data->kc2);
            break;
        case TD_DOUBLE_TAP:
            tap_code16_sjimooon(data->kc3);
            break;
        case TD_DOUBLE_HOLD:
            tap_code16_sjimooon(data->kc4);
            break;
        case TD_DOUBLE_SINGLE_TAP:
            tap_code16_sjimooon(data->kc3);
            break;
