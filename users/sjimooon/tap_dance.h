...
#define ACTION_TAP_DANCE_QUAD(kc1, kc2, kc3, kc4) \
    { .fn = {td_quad_on_each_tap, td_quad_finished, td_quad_reset, NULL}, .user_data = (void *)&((tap_dance_quad_t){kc1, kc2, kc3, kc4}) }

// Tap once for 'kc1', hold to tap 'kc2', doulbe tap to tap 'kc3', and tap and hold to tap 'kc4'.
// Supports custom keycodes.
#define ACTION_TAP_DANCE_QUAD_TAP(kc1, kc2, kc3, kc4) \
    { .fn = {td_quad_tap_on_each_tap, td_quad_tap_finished, NULL, NULL}, .user_data = (void *)&((tap_dance_quad_t){kc1, kc2, kc3, kc4}) }
...
#define ACTION_TAP_DANCE_MOD_TAP_LAYER(kc1, kc2, layer) \
    { .fn = {NULL, td_mod_tap_layer_finished, td_mod_tap_layer_reset, NULL}, .user_data = (void *)&((tap_dance_pair_layer_t){kc1, kc2, layer}) }
...
void td_quad_tap_on_each_tap(tap_dance_state_t *state, void *user_data);
