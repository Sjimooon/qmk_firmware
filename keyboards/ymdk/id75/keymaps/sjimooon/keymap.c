...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[L_COLE] = LAYOUT_ortho_5x15(
        KC_ESC,      KC_1,        KC_2,        KC_3,        KC_4,       KC_5,        KC_ESC,      KC_TRNS,     KC_6,        KC_7,        KC_8,        KC_9,        KC_0,        KC_TRNS,     KC_TRNS,
        KC_DEL,      KC_Q,        KC_W,        KC_F,        KC_P,       KC_G,        KC_TRNS,     KC_TRNS,     KC_J,        KC_L,        KC_U,        KC_Y,        KC_TRNS,     KC_TRNS,     KC_TRNS,
        KC_BSPC,     KC_A,        KC_R,        KC_S,        KC_T,       KC_D,        KC_ENT,      KC_TRNS,     KC_H,        KC_N,        KC_E,        KC_I,        KC_O,        TD(TD_QUOT), TG(L_BRDG),
        KC_LSFT,     KC_Z,        KC_X,        KC_C,        KC_V,       KC_B,        KC_TRNS,     KC_TRNS,     KC_K,        KC_M,        KC_COMM,     KC_DOT,      DK_MINS,     KC_TRNS,     KC_TRNS,
        KC_LCTL,     TD(TD_ATAB), SM_LSA,    OSM(MOD_LALT), CW_TOGG, CTL_T(KC_SPC), LT(L_NAV, KC_TAB), KC_ENT, OSL(L_SYM),  KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS
    ),
    ...
    [L_SYM] = LAYOUT_ortho_5x15(
        KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,    KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,
        KC_TRNS,     DK_HALF,     DK_EXLM,     DK_LCBR,     DK_RCBR,    DK_QUES,     KC_TRNS,     KC_TRNS,     SS_CIRC,     DK_ASTR,     DK_SLSH,     DK_BSLS,     KC_TRNS,     KC_TRNS,     KC_TRNS,
        KC_TRNS,     DK_HASH,     DK_AMPR,     DK_LPRN,     DK_RPRN,    DK_PIPE,     KC_TRNS,     KC_TRNS,     SS_TILD,     DK_LABK,     DK_RABK,     DK_EQL,      DK_AE,       DK_OSTR,     KC_TRNS,
        KC_TRNS,     DK_AT,       DK_DLR,      DK_LBRC,     DK_RBRC,    SS_GRV,      KC_TRNS,     KC_TRNS,     SS_DEG,      DK_PLUS,     DK_MINS,     DK_PERC,     DK_ARNG,     KC_TRNS,     KC_TRNS,
        KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,    KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS
    ),
    [L_NAV] = LAYOUT_ortho_5x15(
        ...
        KC_TRNS,     KC_LSFT,     SM_LSA,      KC_LALT,     KC_LCTL,    KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_PGDN,     KC_LEFT,     KC_DOWN,     KC_RGHT,     KC_INS,      KC_TRNS,     KC_TRNS,
        KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,    KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_APP,      SA_SELW,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,
        KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,    KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS
    ),
